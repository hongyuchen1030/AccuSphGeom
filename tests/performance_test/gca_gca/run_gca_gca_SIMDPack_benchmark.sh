...
SCRIPT_DIR="${REPO_ROOT}/tests/performance_test/gca_gca"
BUILD_DIR="${REPO_ROOT}/build_benchmark"
TARGET="benchmark_gca_gca_SIMDPack"
...
CSV_PATH="${OUTPUT_DIR}/gca_gca_SIMDPack_timing_summary.csv"
REPEATS_CSV_PATH="${OUTPUT_DIR}/gca_gca_SIMDPack_timing_repeats.csv"
PLOT_PATH="${OUTPUT_DIR}/gca_gca_SIMDPack_timing.png"
...
module load python
python3 "${SCRIPT_DIR}/plot_gca_gca_SIMDPack.py" \
  --csv "${CSV_PATH}" \
  --output "${PLOT_PATH}"
