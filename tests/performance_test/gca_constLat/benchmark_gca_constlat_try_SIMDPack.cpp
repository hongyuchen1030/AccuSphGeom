...
constexpr std::size_t kDefaultDataSize = 100000000;
...
int main(int argc, char** argv) {
  ...
  std::cout << "gca_constlat try-API SIMD-pack timing benchmark\n";
  ...
  run_kernel_pair_block<PureFpTryKernel, AccuxTryKernel, TryBuffers>(
      "try_gca_constlat_intersection try-only timing benchmark", data_size,
