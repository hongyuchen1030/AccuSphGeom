#pragma once
#ifndef ACCUSPHGEOM_THIRD_PARTY_PREDICATES_H
#define ACCUSPHGEOM_THIRD_PARTY_PREDICATES_H
...
//   - default: double
//   - define ACCUSPHGEOM_PREDICATES_USE_FLOAT to use float
// -----------------------------------------------------------------------------
#ifdef ACCUSPHGEOM_PREDICATES_USE_FLOAT
typedef float ACCUSPHGEOM_PREDICATES_REAL;
...
#else
typedef double ACCUSPHGEOM_PREDICATES_REAL;
...
#endif  // ACCUSPHGEOM_THIRD_PARTY_PREDICATES_H
